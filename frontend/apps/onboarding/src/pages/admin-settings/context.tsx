...
export type AdminSettingsTab = 'overview' | 'sessions' | 'team' | 'invites' | 'audit' | 'platform'
...
export function useAdminSettings() {
    ...
    if (!value) {
        throw new Error('useAdminSettings must be used inside AdminSettingsContext.Provider')
    }
    return value
}
