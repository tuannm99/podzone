                                    ...
                                    <TableRow>
                                        <TableCell>
                                            ...
                                            <Show when={request.last_error}>
                                                <p class="mt-1 text-xs text-red-700">{request.last_error}</p>
                                            </Show>
                                        </TableCell>
                                        <TableCell>
                                            <Badge
                                        ...
                                        <TableCell class="text-right">
                                            <Button
                                                ...
                                                disabled={
                                                    ...
                                                    !['failed', 'failed_retryable'].includes(request.status)
                                                }
                                                onClick={() => void vm.retryStore(vm.selectedWorkspaceId(), request.id)}
                                            >
                                                Retry
                                            </Button>
                                        </TableCell>
