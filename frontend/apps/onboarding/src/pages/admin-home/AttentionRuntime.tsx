                            ...
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                                ...
                                <div class="mt-3 flex flex-wrap gap-3">
                                    <Button
                                        size="sm"
                                        color="alternative"
                                        href={vm.buildOrdersHref(store.tenantId, store.storeId, 'overdue')}
                                    >
                                        Open overdue
                                    </Button>
                                    <Button
                                        size="sm"
                                        color="alternative"
                                        href={vm.buildOrdersHref(store.tenantId, store.storeId, 'settlement_pending')}
                                    >
                                    ...
                                    <Button
                                        size="sm"
                                        color="alternative"
                                        href={vm.buildOrdersHref(store.tenantId, store.storeId, 'all')}
                                    >
                                        Open priority queue
                                    </Button>
                                </div>
        ...
        <Card class="space-y-4">
            ...
            <div class="space-y-3 text-sm text-gray-600">
                ...
                <div class="rounded-lg bg-gray-50 p-4">
                    ...
                    <p class="mt-1">
                        Use the settings page to manage team access, workspace invites, sessions, and platform
                        administration.
                    </p>
                </div>
            </div>
