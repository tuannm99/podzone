...
export type ActivityFilter = 'all' | 'notes' | 'system' | 'shipment_note' | 'settlement_note' | 'issue_note'
...
export type OrderCardActions = {
    ...
    patchSettlementDraft: (orderId: string, patch: Partial<SettlementDraft>) => void
