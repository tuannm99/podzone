...
import type { GroupInfo, GroupInlinePolicy, PolicyInfo } from '@podzone/shared/services/iam'
...
export type AdminIamGroupContextValue = {
    ...
    attachGroupPolicyFromForm: (values: GroupPolicyAttachmentFormValues) => Promise<void>
    ...
    saveGroupInlinePolicyFromForm: (values: GroupInlinePolicyFormValues) => Promise<void>
...
export function AdminIamGroupProvider(props: ParentProps<{ value: AdminIamGroupContextValue }>) {
    return <AdminIamGroupContext.Provider value={props.value}>{props.children}</AdminIamGroupContext.Provider>
}
