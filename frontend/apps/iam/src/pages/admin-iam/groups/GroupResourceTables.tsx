        ...
        <div class="grid gap-6 xl:grid-cols-2">
            <section class="min-w-0 space-y-3">
                ...
                <Show
                    ...
                    fallback={<EmptyBlock title="No group members" copy="Select a group and add users." />}
                >
                    <DataTable>
                        <TableHead>
                            <TableRow>
                            ...
                            <For each={group.groupMembers()}>
                                {(userID) => {
                                    ...
                                    return (
                                        <TableRow>
                                            <TableCell>
                                                <span class="block font-medium text-gray-900">{identity().label}</span>
            ...
            <section class="min-w-0 space-y-3">
                ...
                <Show
                    ...
                    fallback={<EmptyBlock title="No group policies" copy="Attach a managed policy to this group." />}
                >
                    <DataTable>
                        <TableHead>
                            <TableRow>
        ...
        <div class="space-y-3">
            ...
            >
                ...
                <Pagination
                    ...
                    loading={group.groupInlinePoliciesLoading()}
                    onPageChange={(page) => group.updateGroupInlinePoliciesQuery({ page })}
                />
            </Show>
        </div>
    )
