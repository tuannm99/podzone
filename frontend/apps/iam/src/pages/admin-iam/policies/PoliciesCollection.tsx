    ...
    return (
        <div class="space-y-4">
            <CollectionToolbar
                ...
                onSortDirectionChange={(sortDirection) => policy.updateQuery({ sortDirection })}
            ...
            <Show
                ...
                fallback={
                    <EmptyBlock title="No policies" copy="No managed policies match the current collection query." />
                }
            >
                <DataTable>
                    <TableHead>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell class="text-right">
                                        <Button
                                            type="button"
                                            size="xs"
                                            color={item.name === policy.selectedPolicyName() ? 'dark' : 'alternative'}
