...
export type AdminIamPrincipalContextValue = {
    ...
    attachPrincipalManagedPolicyFromForm: (values: PrincipalManagedPolicyFormValues) => Promise<void>
    ...
    savePrincipalBoundaryFromForm: (values: PrincipalBoundaryFormValues) => Promise<void>
    ...
    savePrincipalInlinePolicyFromForm: (values: PrincipalInlinePolicyFormValues) => Promise<void>
...
export function AdminIamPrincipalProvider(props: ParentProps<{ value: AdminIamPrincipalContextValue }>) {
    return <AdminIamPrincipalContext.Provider value={props.value}>{props.children}</AdminIamPrincipalContext.Provider>
}
