...
import { Button, InputField, SelectField, type SelectOption } from '@podzone/shared/ui/components/common/Primitives'
...
import { OrganizationsCollection, type OrganizationsCollectionProps } from './OrganizationsCollection'
...
type OrganizationsPanelProps = OrganizationsCollectionProps & {
    ...
    handleAddOrganizationMember: (userID: number, roleName: string) => Promise<void>
    ...
    return (
        <div class="space-y-5">
            ...
            <Show when={props.canManagePlatform()}>
                <form class="grid gap-3 md:grid-cols-2" onSubmit={props.submitCreateOrganization}>
                    <InputField
            ...
            <Show when={props.organizationOptions().length > 0}>
                <SelectField
                    ...
                    onChange={(event) => props.setSelectedOrgId(event.currentTarget.value)}
                />
            </Show>
            ...
            <Show when={props.canManagePlatform()}>
                <div class="grid gap-3 md:grid-cols-2">
                    ...
                    <SelectField
                        ...
                        onChange={(event) => props.setOrgPolicyName(event.currentTarget.value)}
                    />
                </div>
