...
export function Carousel(props: { slides: CarouselSlide[]; autoPlay?: boolean; intervalMs?: number; class?: string }) {
    ...
    return (
        <section
            class={classes('overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm', props.class)}
