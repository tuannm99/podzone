...
import { PrincipalInlinePoliciesTable, PrincipalManagedPoliciesTable } from './PrincipalPolicyTables'
        ...
        <>
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <SelectField
                    ...
                    onChange={(e) => principal.setPrincipalMode(e.currentTarget.value as PrincipalMode)}
                />
                <Show
            ...
            <Button type="button" size="sm" color="alternative" onClick={() => void principal.loadPrincipalControls()}>
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div class="space-y-3">
                    ...
                    <p class="text-xs text-gray-500">
                        Direct attachments only affect this principal and stack with group, role, boundary, and SCP
                        evaluation.
                    </p>
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-xs text-gray-500">
                        Boundary policies cap the maximum access this principal can exercise, even when identity
                        policies allow more.
                    </p>
                    <div class="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto_auto] md:items-end">
                        ...
                        <Button size="sm" color="red" onClick={principal.handleDeletePrincipalBoundary}>
                            Delete
                        </Button>
                    </div>
            ...
            <div class="space-y-3">
                <div class="grid gap-3 md:grid-cols-2">
                    ...
                    <FormInputField form={inlinePolicyForm} name="description" label="Inline policy description" />
                </div>
                <IamStatementBuilder
