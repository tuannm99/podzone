...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\x05order\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcd\a\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x0fGetOrderRefunds\x12\x1d.order.GetOrderRefundsRequest\x1a\x1a.order.ListRefundsResponse\"+\x82\xd3\xe4\x93\x02%\x12#/order/v1/orders/{order_id}/refundsB>Z<github.com/tuannm99/podzone/pkg/api/proto/order/v1;pborderv1b\x06proto3"
