...
type PolicyRepository interface {
	CreatePolicy(ctx context.Context, policy entity.Policy, statements []entity.PolicyStatement) (*entity.Policy, []entity.PolicyStatement, error)
	CreatePolicyVersion(ctx context.Context, policyID uint64, policyName string, statements []entity.PolicyStatement, setAsDefault bool) (*entity.PolicyVersion, []entity.PolicyStatement, error)
	...
	GetTenantUserInlinePolicy(ctx context.Context, tenantID string, userID uint, name string) (*entity.UserInlinePolicy, error)
	...
	GetTenantUserPermissionBoundaryStatements(ctx context.Context, tenantID string, userID uint) ([]entity.PolicyStatement, error)
