...
export type QueueView = 'all' | 'my_queue' | 'overdue' | 'delivery_issues' | 'settlement_pending' | 'finance_review'
...
export function TenantOrdersBoardProvider(props: ParentProps<{ value: TenantOrdersBoardContextValue }>) {
    return <TenantOrdersBoardContext.Provider value={props.value}>{props.children}</TenantOrdersBoardContext.Provider>
}
