...
const TenantOrdersInsightsContext = createContext<TenantOrdersInsightsContextValue>()

export function TenantOrdersInsightsProvider(props: ParentProps<{ value: TenantOrdersInsightsContextValue }>) {
    return (
