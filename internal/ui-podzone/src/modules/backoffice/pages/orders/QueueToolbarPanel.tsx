        ...
        <>
            <div class="grid gap-4 md:grid-cols-[0.7fr_0.8fr_1.3fr]">
                ...
                <div class="flex items-end gap-2">
                    ...
                    />
                    <Button type="button" size="sm" color="alternative" onClick={board.applyQueueSearch}>
                        Search
                    </Button>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <Button
                            type="button"
                            size="xs"
                            color={board.activeQueueView() === 'delivery_issues' ? 'red' : 'alternative'}
                        ...
                        <Button
                            type="button"
                            size="xs"
                            color={board.activeQueueView() === 'settlement_pending' ? 'green' : 'alternative'}
                        ...
                        <Button
                            type="button"
                            size="xs"
                            color={board.activeQueueView() === 'finance_review' ? 'red' : 'alternative'}
            ...
            <div class="mt-4 rounded-lg border border-gray-200 bg-white p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <Show
                                ...
                                fallback={<p class="text-sm text-gray-500">No saved presets for this store yet.</p>}
                            >
                ...
                <div class="mt-4">
                    <Button type="button" size="sm" color="green" onClick={board.saveQueuePreset}>
