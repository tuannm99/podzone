    ...
    <div class="mt-3 rounded-md border border-slate-200 bg-slate-50 p-3">
      ...
      <div class="mt-3 grid gap-4 md:grid-cols-2">
        ...
        <InputField
          ...
          value={
            props.actions.shipmentDraftFor(props.order).shipmentTrackingNumber
          }
          placeholder="1Z999..."
          onInput={(event) =>
            props.actions.patchShipmentDraft(props.order.id, {
        ...
        <InputField
          label="Tracking URL"
          value={
            props.actions.shipmentDraftFor(props.order).shipmentTrackingUrl
          }
      ...
      <div class="mt-3 flex flex-wrap items-center gap-2">
        <Button
          ...
          size="xs"
          color="blue"
          onClick={() => props.actions.saveShipment(props.order)}
        >
          Save shipment state
        </Button>
        <Show
          when={
            props.order.shipmentCarrier || props.order.shipmentTrackingNumber
          }
        >
          <Badge
