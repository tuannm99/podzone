    ...
    <PageShell>
      ...
      <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          value={String(home.publishedCandidateCount())}
        />
        <StatCard
          label="Orders in production"
          value={String(home.inProductionCount())}
        />
        <StatCard
          label="Open exceptions"
          value={String(home.openExceptionCount())}
        />
      </div>
      ...
      <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          value={String(home.pendingSettlementCount())}
        />
        <StatCard label="Issue cost" value={home.issueCostExposure()} />
        <StatCard
          label="Shipment SLA overdue"
          value={String(home.shipmentSlaOverdueCount())}
        />
