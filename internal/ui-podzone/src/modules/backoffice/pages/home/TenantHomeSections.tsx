    ...
    <>
      <Card class="space-y-4">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          />
          <Badge
            content={`selected store: ${props.currentStoreId() || 'missing'}`}
            color="indigo"
          />
      ...
      <Card class="space-y-4">
        ...
        <div class="flex flex-wrap gap-3">
          <Button
            ...
            color={
              props.shipmentSlaOverdueCount() > 0 ||
              props.issueSlaOverdueCount() > 0
                ? 'red'
                : 'alternative'
            }
          >
...
function ActionShortcuts(
  props: TenantHomeSectionsProps & { tenantHref: (path: string) => string }
) {
  return (
    <Card class="space-y-4">
      <SectionTitle
