...
import { createPartnersViewModel } from './partners/createPartnersViewModel'
import {
        ...
        <Card class="space-y-4">
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <SelectField
              ...
              onChange={(event) =>
                partners.setFilterPartnerType(event.currentTarget.value)
              }
            />
            <SelectField
              ...
              onChange={(event) =>
                partners.setFilterStatus(event.currentTarget.value)
              }
            />
          </div>
