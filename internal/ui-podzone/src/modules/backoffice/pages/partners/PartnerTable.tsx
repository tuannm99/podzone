        ...
        fallback={
          !props.loading() ? (
            <EmptyBlock
              ...
              copy="No partner records match the current filters."
            />
          ) : null
        }
      >
              ...
              {(partner) => (
                <TableRow>
                  ...
                  <TableCell class="max-w-56 text-gray-600">
                    <p>
                      {joinCapabilityList(partner.supportedProductTypes) ||
                        'Any product'}
                    </p>
                    <p class="mt-1 text-xs text-gray-500">
                      {joinCapabilityList(partner.supportedRegions) ||
                        'Any region'}
                    </p>
                  </TableCell>
                  <TableCell class="whitespace-nowrap text-gray-600">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                      SLA {partner.slaDays || 0} days
                    </p>
                  </TableCell>
                  <TableCell>
                    <Badge
                      content={partner.status}
                      color={badgeColorForStatus(partner.status)}
                    />
                  </TableCell>
                  <TableCell>
                    <div class="flex flex-wrap justify-end gap-2">
                      ...
                      <Button
                        size="xs"
                        color={
                          partner.status === 'active' ? 'alternative' : 'green'
                        }
