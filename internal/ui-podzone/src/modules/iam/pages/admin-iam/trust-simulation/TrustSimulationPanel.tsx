...
import { IamKeyValueBuilder, IamTrustPolicyBuilder } from '@/modules/iam/components'
    ...
    return (
        <>
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <FormInputField form={trustPolicyForm} name="roleName" label="Role name" />
                <InfoAlert>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <Button size="sm" onClick={saveTrustPolicy} loading={trustPolicyForm.isSubmitting()}>
                    Save trust policy
                </Button>
            </div>
            <div class="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto_auto] md:items-end">
                ...
                />
                <Button size="sm" color="dark" onClick={saveRoleBoundary} loading={roleBoundaryForm.isSubmitting()}>
                    Save boundary
                </Button>
            ...
            <Show when={trustPolicyForm.hasError('trustJson')}>
                <p class="text-xs font-medium text-red-600">{trustPolicyForm.error('trustJson')}</p>
            </Show>
                                            ...
                                            <div class="rounded-md bg-gray-50 p-3 text-xs text-gray-600">
                                                <div class="flex flex-wrap items-center gap-2">
                                                    <Badge
                                                        ...
                                                        color={
                                                            statement.effect.toLowerCase() === 'deny' ? 'red' : 'green'
                                                        }
                                                    />
                                                    <Badge
