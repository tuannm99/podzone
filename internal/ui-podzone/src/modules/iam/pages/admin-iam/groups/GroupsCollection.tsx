    ...
    <div class="space-y-4">
      ...
      <CollectionToolbar
        ...
        onSortDirectionChange={(sortDirection) =>
          group.updateQuery({ sortDirection })
        }
      ...
      <Show
        ...
        fallback={
          <EmptyBlock
            title="No groups"
            copy="No groups match the selected scope and collection query."
          />
        }
      >
        <DataTable>
                ...
                <TableRow>
                  ...
                  <TableCell class="text-right">
                    <Button
                      ...
                      size="xs"
                      color={
                        String(item.id) === group.selectedGroupId()
                          ? 'dark'
                          : 'alternative'
                      }
                      onClick={() =>
                        group.setSelectedGroupId(String(item.id || ''))
                      }
                    >
                      Inspect
                    </Button>
