...
export function CreateFirstStore() {
    ...
    return (
        <div class="space-y-3 border border-gray-200 bg-gray-50 p-4">
            <p class="text-sm font-semibold text-gray-950">No stores in this workspace</p>
            <p class="text-sm text-gray-600">Create the first store, then track provisioning below.</p>
            <div class="flex flex-col gap-3 sm:flex-row">
                <div class="min-w-0 flex-1">
                    <FormInputField
                        ...
                        onValueInput={(value) => vm.setDraftStoreName(vm.selectedWorkspaceId(), value)}
                    />
                </div>
                <Button
                    size="sm"
