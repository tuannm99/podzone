...
export function createStoreCollectionsViewModel(
  ...
  const workspaceReady = () =>
    workspaceSession.latest === selectedWorkspaceID().trim()
  ...
  const sessionError = () =>
    workspaceSession.error instanceof Error
      ? workspaceSession.error.message
      : ''
...
export type StoreCollectionsViewModel = ReturnType<
  typeof createStoreCollectionsViewModel
>
