...
import { Button, InputField, SelectField } from '../../../components/common/Primitives';
import {
    ...
    <div class="mt-4 rounded-2xl border border-gray-200 bg-white p-4">
      <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p class="text-sm text-gray-500">
            Selected {board.selectedOrderIDs().length} order(s) in the current
            queue workflow.
          </p>
        </div>
        <div class="flex flex-wrap gap-2">
          <Button
            ...
            size="xs"
            color="alternative"
            onClick={board.selectVisibleOrders}
          >
            Select visible
          </Button>
          <Button
            ...
            size="xs"
            color="light"
            onClick={board.clearSelectedOrders}
          >
            Clear
          </Button>
        </div>
      ...
      <div class="mt-4 grid gap-4 md:grid-cols-3">
        ...
        <SelectField
          ...
          onChange={(event) =>
            board.applyRelativeShipmentSla(
      ...
      <div class="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-4">
        <div class="grid gap-4 md:grid-cols-[0.8fr_1.2fr]">
          <InputField
            ...
            onInput={(event) =>
              board.setBulkTemplateName(event.currentTarget.value)
            }
          />
          <div class="space-y-2">
        ...
        <div class="mt-4">
          <Button
            ...
            size="xs"
            color="green"
            onClick={board.saveBulkTemplate}
          >
