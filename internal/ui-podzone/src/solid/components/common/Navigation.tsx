...
export function Navbar(props: { brand: JSX.Element; items?: NavItem[]; actions?: JSX.Element; class?: string }) {
    return (
        <header class={classes('rounded-lg border border-gray-200 bg-white px-4 py-3 shadow-sm', props.class)}>
...
export function Sidebar(
    ...
    return (
        <aside class={classes('rounded-lg border border-gray-200 bg-white p-4 shadow-sm', props.class)}>
            <div class="space-y-4">
                <Show when={props.title || props.children}>
                    <div class="space-y-2">
                        <Show when={props.title}>
                            <p class="text-xs font-semibold uppercase tracking-[0.22em] text-gray-400">{props.title}</p>
                        </Show>
                        {props.children}
                    </div>
                </Show>
...
export function Footer(
    ...
    return (
        <footer class={classes('rounded-lg border border-gray-200 bg-white px-6 py-5 shadow-sm', props.class)}>
