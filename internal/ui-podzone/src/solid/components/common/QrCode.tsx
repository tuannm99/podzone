...
export function QrCode(props: { value: string; size?: number; class?: string; panelClass?: string }) {
    ...
    return (
        <div class={classes('inline-flex rounded-lg border border-gray-200 bg-white p-4 shadow-sm', props.class)}>
            <Show
                when={svg()}
                fallback={
                    <div
...
export function QrCodeCard(props: { value: string; title?: string; copy?: string; class?: string }) {
    return (
        <section
            class={classes(
