...
export function ClipboardButton(props: { text: string; label?: string; copiedLabel?: string; class?: string }) {
    ...
    return (
        <div class={classes('inline-flex flex-col items-center gap-3', props.class)}>
            <div class="rounded-[2.5rem] border-8 border-gray-900 bg-gray-900 p-3 shadow-xl">
                ...
                <div class={classes('min-h-96 w-[20rem] overflow-hidden rounded-[2rem] bg-white', props.screenClass)}>
                    {props.children}
                </div>
            </div>
