...
export function MegaMenu(props: { brand?: JSX.Element; items: MegaMenuItem[]; actions?: JSX.Element; class?: string }) {
    ...
    return (
        <div
            class={classes('relative rounded-lg border border-gray-200 bg-white px-5 py-4 shadow-sm', props.class)}
