...
export function PanelHeader(props: { title: string; copy?: string; action?: JSX.Element; class?: string }) {
    return (
        <div class={classes('flex flex-col gap-4 md:flex-row md:items-start md:justify-between', props.class)}>
            <div class="space-y-1">
