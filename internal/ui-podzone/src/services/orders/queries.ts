...
export async function getRoutedOrderPage(query: CollectionQuery): Promise<OrdersResult<CollectionPage<RoutedOrder>>> {
...
export async function getRoutedOrders(): Promise<OrdersResult<{ orders: RoutedOrder[] }>> {
