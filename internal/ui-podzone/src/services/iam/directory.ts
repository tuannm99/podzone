...
import type { DirectoryScope, DirectoryUser, IamResult, PermissionInfo } from './types'
...
export async function listAllPermissions(scope: DirectoryScope): Promise<IamResult<PermissionInfo[]>> {
