...
type ProductSetupResult<T> = { success: true; data: T } | { success: false; message: string }
...
export async function getProductSetupSnapshot(): Promise<ProductSetupResult<ProductSetupSnapshot>> {
...
export async function createProductSetupDraft(payload: CreateDraftPayload): Promise<ProductSetupResult<SetupDraft>> {
    const result = await postBackofficeGraphQL<{
