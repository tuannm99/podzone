...
import (
	...
	storedomain "github.com/tuannm99/podzone/internal/onboarding/store"
...
func (c *StoreController) CreateStoreRequest(ctx *gin.Context) {
...
func (c *StoreController) ListStoreRequests(ctx *gin.Context) {
...
func (c *StoreController) GetStoreRequest(ctx *gin.Context) {
	id := ctx.Param("id")
...
func (c *StoreController) UpdateStoreRequestStatus(ctx *gin.Context) {
	id := ctx.Param("id")
...
func (c *StoreController) ApproveStoreRequest(ctx *gin.Context) {
...
func (c *StoreController) RejectStoreRequest(ctx *gin.Context) {
