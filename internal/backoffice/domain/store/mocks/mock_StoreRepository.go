...
//   - ctx context.Context
//   - store1 store.Store
func (_e *MockStoreRepository_Expecter) Create(ctx interface{}, store1 interface{}) *MockStoreRepository_Create_Call {
	return &MockStoreRepository_Create_Call{Call: _e.mock.On("Create", ctx, store1)}
}

func (_c *MockStoreRepository_Create_Call) Run(run func(ctx context.Context, store1 store.Store)) *MockStoreRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStoreRepository_Create_Call) RunAndReturn(run func(ctx context.Context, store1 store.Store) error) *MockStoreRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockStoreRepository_FindByID_Call) Return(store1 *store.Store, err error) *MockStoreRepository_FindByID_Call {
