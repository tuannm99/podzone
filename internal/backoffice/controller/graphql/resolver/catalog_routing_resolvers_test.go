...
func TestCreateRoutedOrderMapsInputAndOutput(t *testing.T) {
	...
	require.Equal(t, routingentity.RoutedOrderSettlementStatusPending, got.SettlementStatus)
}
	...
	orderUC.EXPECT().
		...
		RunAndReturn(func(_ context.Context, query routingentity.RoutedOrderActivityFeedQuery) (*routingentity.RoutedOrderActivityFeedPage, error) {
			...
			return &routingentity.RoutedOrderActivityFeedPage{
				Entries: []routingentity.RoutedOrderActivityFeedEntry{
					{
						OrderID:          "ord-1",
						ProductTitle:     "Vintage Tee",
						Partner:          "Print Partner A",
						...
						Activity: routingentity.RoutedOrderActivity{
							...
							Details:   []routingentity.RoutedOrderActivityDetail{{Key: "carrier", Value: "DHL"}},
							CreatedAt: since,
						},
					},
				},
