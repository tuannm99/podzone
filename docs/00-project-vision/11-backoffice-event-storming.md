...
| 5    | Store provisioning completes           | StoreBecameReady               | StoreWorkspace     | Workspace          | Placement must be resolvable before operation starts                              | Store list                       | Onboarding / Mongo runtime KV |
